function [f_filtered_normalized_dwsp_vector_allsub_train,f_filtered_normalized_dwsp_vector_allsub_test] = PreprocessDataSet()
...
save(['GaborData_expression.mat'],'data')
...
save(['PreprocessedData_expression_orig.mat'],'preprocessedData')
save(['PreprocessedData_expression.mat'],'data')
display 'finished.'
end
