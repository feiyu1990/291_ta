...
root = strcat(pwd, '/../../programming/PA3/jaffe/');
files_temp = dir( fullfile(root,'*.tiff'));   
files = {};
...
for i=1:length(files)
    expressions = [expressions; files{i}(4:5)];
end
...
save(['jaffe_GaborData_expression.mat'],'data')
...
save(['jaffe_PreprocessedData_expression_orig_600.mat'],'preprocessedData')
save(['jaffe_PreprocessedData_expression_600.mat'],'data')
...
save('jaffe_expression_info.mat','information');
