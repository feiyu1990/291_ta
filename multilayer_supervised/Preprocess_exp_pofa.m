...
save(['POFA_GaborData_expression.mat'],'data')
...
save(['POFA_PreprocessedData_expression_orig_30.mat'],'preprocessedData')
save(['POFA_PreprocessedData_expression_30.mat'],'data')
...
save('POFA_expression_info.mat','information');
