function [thetan,fn,fcall] = backtrack(theta,X,y,d,fc,DDfnc,c,gamma,eps)
%
%GENERAL DESCRIPTION
%
...
if c<= 0 || c>= 1,
        error('The slope modification parameter c in the backtracking subroutineis not in (0,1).')
end
if gamma<=0 || gamma >=1,
