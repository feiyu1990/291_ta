...
%
theta_mf=minFunc(@logistic_regression_vec, theta, options, train.X, train.y);

accuracy = binary_classifier_accuracy(theta_mf,train.X,train.y);
fprintf('Training accuracy: %2.1f%%\n', 100*accuracy);

% Print out accuracy on the test set.
accuracy = binary_classifier_accuracy(theta_mf,test.X,test.y);
fprintf('Test accuracy: %2.1f%%\n', 100*accuracy);



lr = .5;
theta_gd = logistic_regression_mine(theta, train.X, train.y, lr);
